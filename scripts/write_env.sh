...
echo "AZURE_OPENAI_REALTIME_VOICE_NAME=$(azd env get-value AZURE_OPENAI_REALTIME_VOICE_NAME)" >> $ENV_FILE_PATH
echo "AZURE_OPENAI_REALTIME_VOICE_MODEL_VERSION=$(azd env get-value AZURE_OPENAI_REALTIME_VOICE_MODEL_VERSION)" >> $ENV_FILE_PATH
...
echo "AZURE_API_ENDPOINT=$(azd env get-value AZURE_API_ENDPOINT)" >> $ENV_FILE_PATH
