...
const DialogContent: React.FC<DialogContentProps> = ({ className, children }) => (
    <div
        className={cn(
            "fixed left-[50%] top-[50%] z-[10000] grid max-h-[90vh] w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 overflow-hidden rounded-lg border border-slate-200 bg-white p-6 shadow-lg",
            className
        )}
    >
        {children}
